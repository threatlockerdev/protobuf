 ...
 * @param {!jspb.BinaryWriter} writer
 */
proto.HelloReply.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
  f = this.getMessage();
  if (f.length > 0) {
    writer.writeString(
...
/**
 * Creates a deep clone of this proto. No data is shared with the original.
 * @return {!proto.HelloReply} The clone.
 */
proto.HelloReply.prototype.cloneMessage = function() {
  return /** @type {!proto.HelloReply} */ (jspb.Message.cloneMessage(this));
};
