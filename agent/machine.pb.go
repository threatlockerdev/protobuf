...
var file_machine_proto_rawDesc = []byte{
	...
	0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x05, 0x66, 0x6f, 0x72, 0x63, 0x65, 0x32, 0x88,
...
var file_machine_proto_goTypes = []interface{}{
	...
	(*StopMachinesRequest)(nil),  // 6: StopMachinesRequest
...
var file_machine_proto_depIdxs = []int32{
	...
	6, // 6: MachineService.Stop:input_type -> StopMachinesRequest
	3, // 7: MachineService.GetMany:output_type -> GetMachinesReply
	5, // 8: MachineService.Create:output_type -> CreateMachineReply
	7, // 9: MachineService.Delete:output_type -> ActionReply
	7, // 10: MachineService.Start:output_type -> ActionReply
	7, // 11: MachineService.Stop:output_type -> ActionReply
