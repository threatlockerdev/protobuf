...
func (x *GetNetworksRequest) GetIds() []uint32 {
	if x != nil {
		return x.Ids
	}
	return nil
...
func (x *CreateNetworkReply) GetId() uint32 {
	if x != nil {
		return x.Id
	}
	return 0
...
var file_network_proto_rawDesc = []byte{
	...
	0x0a, 0x75, 0x74, 0x69, 0x6c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x4d, 0x0a, 0x07, 0x4e,
	...
	0x6d, 0x61, 0x63, 0x68, 0x69, 0x6e, 0x65, 0x49, 0x64, 0x73, 0x22, 0x26, 0x0a, 0x12, 0x47, 0x65,
	...
	0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x02, 0x69, 0x64, 0x32, 0xac,
...
var file_network_proto_depIdxs = []int32{
	...
	2, // 4: NetworkService.GetMany:output_type -> GetNetworksReply
	4, // 5: NetworkService.Create:output_type -> CreateNetworkReply
	5, // 6: NetworkService.Delete:output_type -> ActionReply
