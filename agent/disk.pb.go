...
var file_disk_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x26,
	0x0a, 0x10, 0x47, 0x65, 0x74, 0x46, 0x69, 0x6c, 0x65, 0x53, 0x69, 0x7a, 0x65, 0x52, 0x65, 0x70,
	0x6c, 0x79, 0x12, 0x12, 0x0a, 0x04, 0x73, 0x69, 0x7a, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03,
	0x52, 0x04, 0x73, 0x69, 0x7a, 0x65, 0x22, 0x3a, 0x0a, 0x10, 0x57, 0x72, 0x69, 0x74, 0x65, 0x46,
	...
	0x74, 0x61, 0x32, 0x83, 0x02, 0x0a, 0x0b, 0x44, 0x69, 0x73, 0x6b, 0x53, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x12, 0x2c, 0x0a, 0x08, 0x43, 0x6f, 0x70, 0x79, 0x46, 0x69, 0x6c, 0x65, 0x12, 0x10,
	...
	0x65, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x12, 0x2e, 0x0a, 0x09, 0x57, 0x72, 0x69, 0x74,
	0x65, 0x46, 0x69, 0x6c, 0x65, 0x12, 0x11, 0x2e, 0x57, 0x72, 0x69, 0x74, 0x65, 0x46, 0x69, 0x6c,
...
var file_disk_proto_goTypes = []interface{}{
	...
	(*WriteFileRequest)(nil),     // 4: WriteFileRequest
...
var file_disk_proto_depIdxs = []int32{
	...
	1, // 3: DiskService.GetFileSize:input_type -> FileRequest
	4, // 4: DiskService.WriteFile:input_type -> WriteFileRequest
	5, // 5: DiskService.CopyFile:output_type -> ActionReply
	5, // 6: DiskService.DeleteFile:output_type -> ActionReply
	2, // 7: DiskService.GetFileContents:output_type -> GetFileContentsReply
	3, // 8: DiskService.GetFileSize:output_type -> GetFileSizeReply
	5, // 9: DiskService.WriteFile:output_type -> ActionReply
